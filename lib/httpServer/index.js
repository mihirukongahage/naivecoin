...
class HttpServer {
    constructor(node, blockchain, operator, minter, generator) {
        this.app = express();
        ...
        this.app.get('/miner/location', (req, res) => {
            let location = minter.getLocation(generator, req.body.rewardAddress, req.body['feeAddress'] || req.body.rewardAddress);
