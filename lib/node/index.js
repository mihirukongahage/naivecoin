...
class Node {
    constructor(host, port, peers, blockchain, dbName, generator) {
        this.host = host;
        this.port = port;
        this.peers = [];
    ...
    getVerification(peer) {
        ...
        return superagent.post(URL).then((res) => {
            ...
            this.generator.verifyData(verificationData)


            // broadcast verified data
            this.broadcastVerifiedData(verificationData)
     ...
     */
    broadcastInitialData(peer, data) {
        // Create a db for peers 
        const URL = `${peer}/initial_data`;
    ...
    /**
     * Store N1, N2 and blockhash locally
     */
    ...
    createTicket(data) {
        ...
        // Verify data
        let x = this.generator.verifyFinalData(data);

        // Create a ticket
        let y = this.generator.createTicket(data);
    }
