...
class Minter {
    ...
    getLocation(generator, rewardAddress, feeAddress) {
        ...
        let initialData = generator.getGeneratedData(newBlock.transactionHash) 

        // Store newly created block
        this.newBlockDb.write({
            newBlock: newBlock,
            N1: initialData.N1,
            N2: initialData.N2,
            location: initialData.location,
            transactionList: newBlock.transactions
        });
        ...
        this.node.broadcastInitialData({
            publicKey: publicKey,
            transactionListHash: CryptoUtil.hash(JSON.stringify(newBlock.transactions)),
            locationListHash: CryptoUtil.hash(JSON.stringify(this.locations)),
            hashedN1: CryptoUtil.hash(JSON.stringify(initialData.N1)),
            hashedN2: CryptoUtil.hash(JSON.stringify(initialData.N2)),
    ...
    connect() {
        ...
        let data = {
            ...
            N1: this.newBlock.N1,
            N2: this.newBlock.N2,
            transactionList: this.newBlock.transactionList,
            locationList: this.locations,
            blockHash: this.newBlock.newBlock.hash // For references
        }
