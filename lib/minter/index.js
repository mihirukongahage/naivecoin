...
class Minter {
    ...
    getLocation(generator,rewardAddress, feeAddress) {
        ...
        // Generate N1, N2
        let N1 = generator.n1Generator(newBlock.transactionHash);
        let N2 = generator.n2Generator(newBlock.transactionHash, N1);

        let location = generator.generateLocation(N1);
