...
class Minter {
    ...
    mine(rewardAddress, feeAddress) {
        let baseBlock = Minter.generateNextBlock(rewardAddress, feeAddress, this.blockchain);
        ...
        const thread = spawn(function (input, done) {
            ...
            const Minter = require(input.__dirname);
            /*eslint-enable */

            done(Minter.proveWorkFor(Block.fromJson(input.jsonBlock), input.difficulty));
        });
